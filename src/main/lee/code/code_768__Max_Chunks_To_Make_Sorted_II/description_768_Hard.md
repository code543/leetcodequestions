##[768.Max Chunks To Make Sorted II](https://leetcode.com/problems/max-chunks-to-make-sorted-ii/description/ "768.Max Chunks To Make Sorted II")
######Difficulty:Hard
####Similiar Topics:
  [Array](https://leetcode.com//tag/array)
####Similiar Problems:
  [Max Chunks To Make Sorted](https://leetcode.com//problems/max-chunks-to-make-sorted)
<div class="question-description__3U1T" style="padding-top: 10px;"><div><p><em>This question is the same as "Max Chunks to Make Sorted" except the integers of the given array are not necessarily distinct, the input array could be up to length <code>2000</code>, and the elements could be up to <code>10**8</code>.</em></p>
