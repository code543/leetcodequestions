##[454.4Sum II](https://leetcode.com/problems/4sum-ii/description/ "454.4Sum II")
######Difficulty:Medium
####Similiar Topics:
  [Hash Table](https://leetcode.com//tag/hash-table)  [Binary Search](https://leetcode.com//tag/binary-search)
####Similiar Problems:
  [4Sum](https://leetcode.com//problems/4sum)
<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Given four lists A, B, C, D of integer values, compute how many tuples <code>(i, j, k, l)</code> there are such that <code>A[i] + B[j] + C[k] + D[l]</code> is zero.</p>
