##[899.Orderly Queue](https://leetcode.com/problems/orderly-queue/description/ "899.Orderly Queue")
######Difficulty:Hard
####Similiar Topics:
  [Math](https://leetcode.com//tag/math)  [String](https://leetcode.com//tag/string)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>A string <code>S</code> of lowercase letters is given.&#160; Then, we may make any number of <em>moves</em>.</p>
