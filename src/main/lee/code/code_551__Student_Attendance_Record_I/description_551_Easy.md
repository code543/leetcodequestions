##[551.Student Attendance Record I](https://leetcode.com/problems/student-attendance-record-i/description/ "551.Student Attendance Record I")
######Difficulty:Easy
####Similiar Topics:
  [String](https://leetcode.com//tag/string)
####Similiar Problems:
  [Student Attendance Record II](https://leetcode.com//problems/student-attendance-record-ii)
<div class="question-description__3U1T" style="padding-top: 10px;"><div>You are given a string representing an attendance record for a student. The record only contains the following three characters:
