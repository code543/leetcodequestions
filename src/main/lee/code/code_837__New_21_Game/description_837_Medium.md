##[837.New 21 Game](https://leetcode.com/problems/new-21-game/description/ "837.New 21 Game")
######Difficulty:Medium
####Similiar Topics:
  [Dynamic Programming](https://leetcode.com//tag/dynamic-programming)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Alice plays the following game, loosely based on the card game "21".</p>
