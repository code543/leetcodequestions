##[321.Create Maximum Number](https://leetcode.com/problems/create-maximum-number/description/ "321.Create Maximum Number")
######Difficulty:Hard
####Similiar Topics:
  [Dynamic Programming](https://leetcode.com//tag/dynamic-programming)  [Greedy](https://leetcode.com//tag/greedy)
####Similiar Problems:
  [Maximum Swap](https://leetcode.com//problems/maximum-swap)  [Remove K Digits](https://leetcode.com//problems/remove-k-digits)
<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Given two arrays of length <code>m</code> and <code>n</code> with digits <code>0-9</code> representing two numbers. Create the maximum number of length <code>k &lt;= m + n</code> from digits of the two. The relative order of the digits from the same array must be preserved. Return an array of the <code>k</code> digits.</p>
