...
<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Alex and Lee play a game with piles of stones.&#160; There are an even number of&#160;piles <strong>arranged in a row</strong>, and each pile has a positive integer number of stones <code>piles[i]</code>.</p>
