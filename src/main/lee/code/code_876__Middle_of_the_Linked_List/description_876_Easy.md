##[876.Middle of the Linked List](https://leetcode.com/problems/middle-of-the-linked-list/description/ "876.Middle of the Linked List")
######Difficulty:Easy
####Similiar Topics:
  [Linked List](https://leetcode.com//tag/linked-list)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Given a non-empty, singly&#160;linked list with head node <code>head</code>, return&#160;a&#160;middle node of linked list.</p>
