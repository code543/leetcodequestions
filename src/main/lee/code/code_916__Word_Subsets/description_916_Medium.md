##[916.Word Subsets](https://leetcode.com/problems/word-subsets/description/ "916.Word Subsets")
######Difficulty:Medium
####Similiar Topics:
  [String](https://leetcode.com//tag/string)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>We are given two arrays <code>A</code> and <code>B</code> of words.&#160; Each word is a string of lowercase letters.</p>
