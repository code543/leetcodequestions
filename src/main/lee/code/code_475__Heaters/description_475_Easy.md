##[475.Heaters](https://leetcode.com/problems/heaters/description/ "475.Heaters")
######Difficulty:Easy
####Similiar Topics:
  [Binary Search](https://leetcode.com//tag/binary-search)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Winter is coming! Your first job during the contest is to design a standard heater with fixed warm radius to warm all the houses.</p>
