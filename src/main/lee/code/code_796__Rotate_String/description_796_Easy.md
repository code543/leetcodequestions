##[796.Rotate String](https://leetcode.com/problems/rotate-string/description/ "796.Rotate String")
######Difficulty:Easy
####Similiar Topics:

####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>We are given two strings, <code>A</code> and <code>B</code>.</p>
