##[655.Print Binary Tree](https://leetcode.com/problems/print-binary-tree/description/ "655.Print Binary Tree")
######Difficulty:Medium
####Similiar Topics:
  [Tree](https://leetcode.com//tag/tree)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Print a binary tree in an m*n 2D string array following these rules: </p>
