##[868.Binary Gap](https://leetcode.com/problems/binary-gap/description/ "868.Binary Gap")
######Difficulty:Easy
####Similiar Topics:
  [Math](https://leetcode.com//tag/math)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Given a positive&#160;integer <code>N</code>, find and return the longest distance between two consecutive 1's in the binary representation of <code>N</code>.</p>
