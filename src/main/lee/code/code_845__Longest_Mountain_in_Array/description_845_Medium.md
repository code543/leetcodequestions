##[845.Longest Mountain in Array](https://leetcode.com/problems/longest-mountain-in-array/description/ "845.Longest Mountain in Array")
######Difficulty:Medium
####Similiar Topics:
  [Two Pointers](https://leetcode.com//tag/two-pointers)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Let's call any (contiguous) subarray B (of A)&#160;a <em>mountain</em> if the following properties hold:</p>
