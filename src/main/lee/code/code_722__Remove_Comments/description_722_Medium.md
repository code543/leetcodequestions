##[722.Remove Comments](https://leetcode.com/problems/remove-comments/description/ "722.Remove Comments")
######Difficulty:Medium
####Similiar Topics:
  [String](https://leetcode.com//tag/string)
####Similiar Problems:
  [Ternary Expression Parser](https://leetcode.com//problems/ternary-expression-parser)  [Mini Parser](https://leetcode.com//problems/mini-parser)
<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Given a C++ program, remove comments from it. The program <code>source</code> is an array where <code>source[i]</code> is the <code>i</code>-th line of the source code.  This represents the result of splitting the original source code string by the newline character <code>\n</code>.</p>
