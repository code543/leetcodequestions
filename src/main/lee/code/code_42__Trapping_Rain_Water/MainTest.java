package lee.code.code_42__Trapping_Rain_Water;
...
* @see  lee.codetest.code_42__Trapping_Rain_Water.CodeTest
* Run solution from Main Judge Class: 
* @see  lee.code.code_42__Trapping_Rain_Water.C42_MainClass
* 
*/
