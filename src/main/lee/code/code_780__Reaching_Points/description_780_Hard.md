##[780.Reaching Points](https://leetcode.com/problems/reaching-points/description/ "780.Reaching Points")
######Difficulty:Hard
####Similiar Topics:
  [Math](https://leetcode.com//tag/math)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>A move consists of taking a point <code>(x, y)</code> and transforming it to either <code>(x, x+y)</code> or <code>(x+y, y)</code>.</p>
