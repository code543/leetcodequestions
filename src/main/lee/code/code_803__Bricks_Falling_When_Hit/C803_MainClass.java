package lee.code.code_803__Bricks_Falling_When_Hit;
...
public class C803_MainClass {
public static String testCase = "[[1,0,0,0],[1,1,1,0]]\n[[1,0]]";
/*
...
*/
    public static void main(String[] args) throws IOException {
        ...
        while ((line = in.readLine()) != null) {
            ...
            line = in.readLine();
            int[][] hits = Utils.stringToInt2dArray(line);
            
            int[] ret = new Solution().hitBricks(grid, hits);
