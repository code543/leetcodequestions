##[501.Find Mode in Binary Search Tree](https://leetcode.com/problems/find-mode-in-binary-search-tree/description/ "501.Find Mode in Binary Search Tree")
######Difficulty:Easy
####Similiar Topics:
  [Tree](https://leetcode.com//tag/tree)
####Similiar Problems:
  [Validate Binary Search Tree](https://leetcode.com//problems/validate-binary-search-tree)
<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Given a binary search tree (BST) with duplicates, find all the <a href="https://en.wikipedia.org/wiki/Mode_(statistics)" target="_blank">mode(s)</a> (the most frequently occurred element) in the given BST.</p>
