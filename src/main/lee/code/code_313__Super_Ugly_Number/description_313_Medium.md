##[313.Super Ugly Number](https://leetcode.com/problems/super-ugly-number/description/ "313.Super Ugly Number")
######Difficulty:Medium
####Similiar Topics:
  [Math](https://leetcode.com//tag/math)  [Heap](https://leetcode.com//tag/heap)
####Similiar Problems:
  [Ugly Number II](https://leetcode.com//problems/ugly-number-ii)
<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Write a program to find the <code>n<sup>th</sup></code> super ugly number.</p>
