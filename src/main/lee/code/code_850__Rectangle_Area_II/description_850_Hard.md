##[850.Rectangle Area II](https://leetcode.com/problems/rectangle-area-ii/description/ "850.Rectangle Area II")
######Difficulty:Hard
####Similiar Topics:
  [Segment Tree](https://leetcode.com//tag/segment-tree)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>We are given a list of (axis-aligned)&#160;<code>rectangles</code>.&#160; Each&#160;<code>rectangle[i] = [x1, y1, x2, y2]&#160;</code>, where (x1, y1) are the coordinates of the bottom-left corner, and (x2, y2) are the coordinates of the top-right corner of the <code>i</code>th rectangle.</p>
