##[692.Top K Frequent Words](https://leetcode.com/problems/top-k-frequent-words/description/ "692.Top K Frequent Words")
######Difficulty:Medium
####Similiar Topics:
  [Heap](https://leetcode.com//tag/heap)  [Hash Table](https://leetcode.com//tag/hash-table)  [Trie](https://leetcode.com//tag/trie)
####Similiar Problems:
  [Top K Frequent Elements](https://leetcode.com//problems/top-k-frequent-elements)
<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Given a non-empty list of words, return the <i>k</i> most frequent elements.</p>
