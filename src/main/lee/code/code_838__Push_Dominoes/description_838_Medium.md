##[838.Push Dominoes](https://leetcode.com/problems/push-dominoes/description/ "838.Push Dominoes")
######Difficulty:Medium
####Similiar Topics:
  [Dynamic Programming](https://leetcode.com//tag/dynamic-programming)  [Two Pointers](https://leetcode.com//tag/two-pointers)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>There are<font face="monospace">&#160;<code>N</code></font> dominoes in a line, and we place each domino vertically upright.</p>
