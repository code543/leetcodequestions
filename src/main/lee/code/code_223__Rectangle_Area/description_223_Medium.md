##[223.Rectangle Area](https://leetcode.com/problems/rectangle-area/description/ "223.Rectangle Area")
######Difficulty:Medium
####Similiar Topics:
  [Math](https://leetcode.com//tag/math)
####Similiar Problems:
  [Rectangle Overlap](https://leetcode.com//problems/rectangle-overlap)
<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Find the total area covered by two <strong>rectilinear</strong> rectangles in a <strong>2D</strong> plane.</p>
