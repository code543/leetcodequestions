##[726.Number of Atoms](https://leetcode.com/problems/number-of-atoms/description/ "726.Number of Atoms")
######Difficulty:Hard
####Similiar Topics:
  [Stack](https://leetcode.com//tag/stack)  [Hash Table](https://leetcode.com//tag/hash-table)  [Recursion](https://leetcode.com//tag/recursion)
####Similiar Problems:
  [Decode String](https://leetcode.com//problems/decode-string)  [Encode String with Shortest Length](https://leetcode.com//problems/encode-string-with-shortest-length)  [Parse Lisp Expression](https://leetcode.com//problems/parse-lisp-expression)
<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Given a chemical <code>formula</code> (given as a string), return the count of each atom.
</p><p>
