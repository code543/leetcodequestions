##[853.Car Fleet](https://leetcode.com/problems/car-fleet/description/ "853.Car Fleet")
######Difficulty:Medium
####Similiar Topics:
  [Stack](https://leetcode.com//tag/stack)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p><code>N</code> cars are going to the same destination along a one lane road.&#160; The destination is <code>target</code>&#160;miles away.</p>
