##[788.Rotated Digits](https://leetcode.com/problems/rotated-digits/description/ "788.Rotated Digits")
######Difficulty:Easy
####Similiar Topics:
  [String](https://leetcode.com//tag/string)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>X is a good number if after rotating each digit individually by 180 degrees, we get a valid number that is different from X.&#160; Each digit must be rotated - we cannot choose to leave it alone.</p>
