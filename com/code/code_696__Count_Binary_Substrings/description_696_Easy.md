##[696.Count Binary Substrings](https://leetcode.com/problems/count-binary-substrings/description/ "696.Count Binary Substrings")
######Difficulty:Easy
####Similiar Topics:
  [String](https://leetcode.com//tag/string)
####Similiar Problems:
  [Encode and Decode Strings](https://leetcode.com//problems/encode-and-decode-strings)
<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Give a string <code>s</code>, count the number of non-empty (contiguous) substrings that have the same number of 0's and 1's, and all the 0's and all the 1's in these substrings are grouped consecutively. 
</p>
