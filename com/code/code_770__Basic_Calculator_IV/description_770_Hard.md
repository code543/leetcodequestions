##[770.Basic Calculator IV](https://leetcode.com/problems/basic-calculator-iv/description/ "770.Basic Calculator IV")
######Difficulty:Hard
####Similiar Topics:
  [Stack](https://leetcode.com//tag/stack)  [Hash Table](https://leetcode.com//tag/hash-table)  [String](https://leetcode.com//tag/string)
####Similiar Problems:
  [Basic Calculator III](https://leetcode.com//problems/basic-calculator-iii)  [Parse Lisp Expression](https://leetcode.com//problems/parse-lisp-expression)
<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>Given an <code>expression</code>&#160;such as <code>expression = "e + 8 - a + 5"</code> and an evaluation map such as <code>{"e": 1}</code> (given in terms of <code>evalvars = ["e"]</code> and <code>evalints = [1]</code>), return a list of tokens representing the simplified expression, such as <code>["-1*a","14"]</code></p>
