##[874.Walking Robot Simulation](https://leetcode.com/problems/walking-robot-simulation/description/ "874.Walking Robot Simulation")
######Difficulty:Easy
####Similiar Topics:
  [Greedy](https://leetcode.com//tag/greedy)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>A robot on an infinite grid starts at point (0, 0) and faces north.&#160; The robot can receive one of three possible types of commands:</p>
