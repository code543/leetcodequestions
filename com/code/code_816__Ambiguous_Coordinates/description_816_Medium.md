##[816.Ambiguous Coordinates](https://leetcode.com/problems/ambiguous-coordinates/description/ "816.Ambiguous Coordinates")
######Difficulty:Medium
####Similiar Topics:
  [String](https://leetcode.com//tag/string)
####Similiar Problems:

<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>We had some 2-dimensional coordinates, like <code>"(1, 3)"</code> or <code>"(2, 0.5)"</code>.&#160; Then, we removed&#160;all commas, decimal points, and spaces, and ended up with the string&#160;<code>S</code>.&#160; Return a list of strings representing&#160;all possibilities for what our original coordinates could have been.</p>
