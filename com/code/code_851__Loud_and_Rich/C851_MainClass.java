package lee.code.code_851__Loud_and_Rich;
...
public class C851_MainClass {
public static String testCase = "[[1,0],[2,1],[3,1],[3,7],[4,3],[5,3],[6,3]]\n[3,2,5,4,6,1,7,0]";
/*
...
*/
    public static void main(String[] args) throws IOException {
        ...
        while ((line = in.readLine()) != null) {
            int[][] richer = Utils.stringToInt2dArray(line);
            line = in.readLine();
            int[] quiet = Utils.stringToIntegerArray(line);
            
            int[] ret = new Solution().loudAndRich(richer, quiet);
