##[413.Arithmetic Slices](https://leetcode.com/problems/arithmetic-slices/description/ "413.Arithmetic Slices")
######Difficulty:Medium
####Similiar Topics:
...
<div class="question-description__3U1T" style="padding-top: 10px;"><div><p>A sequence of number is called arithmetic if it consists of at least three elements and if the difference between any two consecutive elements is the same.</p>
